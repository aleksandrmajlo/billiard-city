<template>
    <div class="tabs" v-show="showAddForm || showReadForm">
        ...
        <ul class="tabs__caption">
            <li :class="{ active: showReadForm }" @click="setActiveReadForm">
                Редагування
            </li>
            <li :class="{ active: showAddForm }" @click="setActiveAddForm">
                Додати бронь
            </li>
        </ul>
            ...
            <div class="reservation__block form-user">
                <form v-on:submit.prevent>
                    <div class="row">
                        ...
                        <div class="col-xs-8 col-xs-xs-12">
                            <select v-model="booking.id_table">
                                <option v-for="table in tables" :value="table.value">{{table.text}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div
                                    class="col-lg-8 col-md-4 col-xs-4 col-xs-xs-12 lg-pdd right-pdd right-podd"
                            >
                            ...
                            <div class="lg-pdd">
                                <div class="radio-confirm">
                                    ...
                                    <input
                                            ...
                                            value="2"
                                    />
                                    <label class="label" for="Requir2">Оплачено</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            ...
                            <div class="lg-pdd">
                                <div class="radio-source">
                                    ...
                                    <input
                                            ...
                                            value="application"
                                    />
                                    <label class="label" for="site111">Додаток</label>
            ...
            <div class="reservation__block form-user">
                <form v-on:submit.prevent>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div
                                    class="col-lg-8 col-xs-4 col-xs-xs-12 lg-pdd right-pdd right-podd"
                            >
                                <label>Дата початку броні :</label>
                            </div>
                            ...
                            <div class="lg-pdd">
                                <div class="radio-confirm">
                                    ...
                                    <input
                                            ...
                                            value="2"
                                    />
                                    <label class="label" for="Requir223">Оплачено</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            ...
                            <div class="no-pdd">
                                <div class="radio-source">
                                    ...
                                    <input
                                            ...
                                            value="application"
                                    />
                                    <label class="label" for="site11">Додаток</label>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.add.to = Year + '-' + Month + "-" + day;
            this.add.from = Year + '-' + Month + "-" + day;
            ;
            axios
        ...
        methods: {
            ...
            submitAddForm() {
                if (
                    ...
                    this.showShwal("error", this.$t("booking_error"));
                    return false;
                }
                axios
                    ...
                    .then((response) => {
                        ...
                        eventBus.$emit('UpdateCalendarDate');
                    })
                    .catch((error) => {
                    })
                    .finally(function () {
            ...
            saveBooking() {
                if (
                    this.booking.id_table == "" ||
                    this.booking.id_table === null||
                    this.booking.from == "" ||
