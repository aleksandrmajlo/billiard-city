            ...
            <div class="col-md-10">
                <div class="inventory">
                    ...
                    <div class="batton_block">
                        ...
                        <div v-if="show_count_sklad" class="button-cover activ">
        ...
        methods: {
            ...
            Next() {
                if (this.validateChangeCat()) {
                    ...
                    this.showShwal('info',this.$t('change_info'));
                }
            },
            //установка категории
            ...
            setBackgroundColor(id) {
                let i = this.products[this.ActiveCategory].map(item => item.id).indexOf(id);
                if (typeof this.products[this.ActiveCategory][i].result == "undefined" || this.products[this.ActiveCategory][i].result == "") {
            ...
            setBackgroundColorKava() {
                if (typeof this.kava.result == "undefined" || this.kava.result == "") {
