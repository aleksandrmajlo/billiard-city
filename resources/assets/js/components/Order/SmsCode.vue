        ...
        <div class="modal-dialog modal-my2" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                      <div class="modalHeader">{{text1}}</div>

                      <div v-if="error" class="alert alert-warning" role="alert">
                           {{text4}}
                      </div>
                      <div v-if="suc" class="alert alert-success" role="alert">
                           {{text5}} - {{skidka}} %
                      </div>
                      <div class="buttonBlock">
                          ...
                          <div class="itemBtton rightItem">
                              <button :disabled="disabled" class="btn btn-warning "  @click.prevent="checkCode">{{text3}}</button>
                          </div>
                      </div>
                </div>
            </div>
