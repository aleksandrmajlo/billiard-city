                                        ...
                                        @if(count($orders) > 0)
                                            @foreach($orders as $k=>$order)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @foreach ($order->tableReservation as $reservat)
                                                            {{ Carbon\Carbon::parse($reservat->booking_from )->format('d-m-Y H:i') }}
                                                        @endforeach
                                                    </td>
                                                    <td>
                                                        @if( !$order->activepause )
                                                            <timer-table table_id="{{$order->table_id}}"
                                                                         date="{{$order->start}}"></timer-table>
                                                        @endif
                                                    ...
                                                    <td class="tr_button">
                                                        <div class="buttonOpenTableConteer">
                                                            ...
                                                            {{-- @if ($order->table_id==29) --}}
                                                            {{-- <order-test id="{{$order->id}}"></order-test> --}}
                                                            {{-- @else --}}
